...
oldlink.addEventListener("click", () => {
    let oldtemples = temples.filter(temple => Number(temple.dedicated.substring(0, 4)) < 1900);
    createTempleCard(oldtemples);
})

const newlink = document.getElementById('new');
newlink.addEventListener("click", () => {
    let newtemples = temples.filter(temple => Number(temple.dedicated.substring(0, 4) > 2000));
